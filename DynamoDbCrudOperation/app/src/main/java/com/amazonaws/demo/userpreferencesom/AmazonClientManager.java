...
public class AmazonClientManager {
    ...
    public boolean hasCredentials() {
        return (!(Constants.IDENTITY_POOL_ID.equalsIgnoreCase("ap-south-1:267c3de4-0f06-4b2d-9b90-10c77215fbad")
                || Constants.TEST_TABLE_NAME.equalsIgnoreCase("User_Details")));
    }
